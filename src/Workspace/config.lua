--[[
This is the configuration module for LundstrongOrders, where all of your settings can be changed. Make sure to read the instructions carefully. If you have any problems or need support, make sure to get on our communications server!
]]
...
return {
	...
	['MenuItems'] = require(script.Parent.MenuItemsConfig)
}
